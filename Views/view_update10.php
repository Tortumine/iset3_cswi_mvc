...
<div class=" col-md-offset-3 col-md-5">
    ...
    <div class="form-login">
        <form action="index.php?action=update10&user=<?= $user5['login'] ?>" id="form" method="post" name='update10'>
            ...
            <select name="userLevel" id="userLevel" class="form-control" value=<?= $user5['security_level'] ?>>
